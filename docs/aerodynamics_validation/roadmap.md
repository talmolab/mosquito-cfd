...
**Sequencing.** T1a → T1b → T2a → T2b → T3a → T3b → T4. **T1a/T1b/T2a/T2b/T3a/T3b complete (2026-07);
T4 (per-component force decomposition, #40) is next.** T3b landed the graded medium run + the RESULTS
...
T4 is in-bounds (post-submission window).
